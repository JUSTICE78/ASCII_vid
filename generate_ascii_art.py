...
def imgsc(image, new_width=100, new_height=30):
    ...
    imgnew = image.resize((new_width, new_height))
    return imgnew
...
def convert_img_to_ascii(image, new_width=100, new_height=30):
    image = imgsc(image, new_width, new_height)
...
def handle_image_conversion(image_filepath):
    ...
    try:
        ...
        print(e)
        return
    image_ascii = convert_img_to_ascii(image)
    return image_ascii
